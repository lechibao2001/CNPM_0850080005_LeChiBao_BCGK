...
class _HiveBoxesListState extends State<HiveBoxesList> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Hive Boxes List'),
      ),
      body: Container(
        decoration: const BoxDecoration(
          image: DecorationImage(
            image: NetworkImage('https://img4.thuthuatphanmem.vn/uploads/2020/06/22/ba-bong-hoa-hong-trung-tren-mot-canh_090941406.jpg'),
            fit: BoxFit.cover,
          ),
        ),
        child: Column(
